...
## ⚠️ IMPORTANTE: Sistema de Avaliações Anônimas

A aplicação implementa **avaliações anônimas e bidirecionais**. Certifique-se de que as configurações de produção mantêm a segurança e anonimato.
