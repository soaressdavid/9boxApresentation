...
const queryCompetencySchema = Joi.object({
...
class CompetencyService {
  ...
  async create(data, userTipo) {
    // Apenas admin e gestor podem criar competências
  ...
  async update(id, data, userTipo) {
    // Apenas admin e gestor podem atualizar competências
    if (userTipo === 'colaborador') {
...
// Rotas de gestor/admin - criar e atualizar
router.post('/', isGestorOrAdminMiddleware, validate(createCompetencySchema), (req, res, next) => competencyController.create(req, res, next));
router.put('/:id', isGestorOrAdminMiddleware, validate(updateCompetencySchema), (req, res, next) => competencyController.update(req, res, next));

// Rotas de admin - deletar
